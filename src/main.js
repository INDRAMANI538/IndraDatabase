...
// CONSTANTS & STATE
// ============================================================
const ADMIN_CODE = 'ADMIN@SMS2024';
const PAGE_SIZE  = 10;
  ...
  try {
    ...
    document.getElementById('page-content').innerHTML = `
      ...
      <div class="table-wrapper">
        ${recent.length === 0
          ? emptyStateHTML('No students yet', 'Start by adding your first student.')
          : `<table>
    ...
    document.getElementById('page-content').innerHTML =
      `<div class="empty-state"><p style="color:var(--error)">Error loading dashboard. Check console for details.</p></div>`;
  }
}
...
async function loadAndRenderStudents() {
  try {
    ...
    document.getElementById('students-list').innerHTML =
      `<div class="empty-state"><p style="color:var(--error)">Error loading students. Check console.</p></div>`;
  }
}
...
['student-modal-overlay', 'view-modal-overlay', 'delete-modal-overlay'].forEach(id => {
...
document.addEventListener('keydown', e => {
  if (e.key === 'Escape') { closeStudentModal(); closeViewModal(); closeDeleteModal(); }
});
...
// ============================================================
// EXPOSE TO GLOBAL SCOPE (required for inline onclick in HTML)
// ============================================================
